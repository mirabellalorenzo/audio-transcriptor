...
public class HomeView {
    ...
    public void start(Stage primaryStage) {
        ...
        SidebarComponent sidebar = new SidebarComponent(boundary, primaryStage, boundary.getUserEmail(), boundary.getUserPhotoUrl());

        noteDetail = new NoteDetailComponent(notes.isEmpty() ? new Note(null, null, "No notes", "") : notes.get(0), new NoteDetailComponent.NoteChangeListener() {
            @Override
