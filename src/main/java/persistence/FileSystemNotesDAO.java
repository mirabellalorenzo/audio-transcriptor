...
public class FileSystemNotesDAO implements NotesDAO {
    ...
    private static String encryptAES(String data, String key) throws GeneralSecurityException {
        try {
            ...
            throw new GeneralSecurityException("Errore nella crittografia AES: " + e.getMessage(), e);
        }                
    }    
    ...
    private static String decryptAES(String encryptedData, String key) throws GeneralSecurityException {
        try {
            ...
            throw new GeneralSecurityException("Errore nella decrittografia AES: " + e.getMessage(), e);
        } catch (IllegalArgumentException e) {
            throw new GeneralSecurityException("Errore nel formato dei dati crittografati: " + e.getMessage(), e);
        }              
    }
}
